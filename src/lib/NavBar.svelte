...
<nav>
  <!-- nav bar  -->
  <div class=" bg-blue-900 flex  justify-between sm:justify-around items-center  ">

    <!-- logo and text for the logo (each with it own div ) -->
    ...
    <!-- menue for the big screans  -->

  <div class=" font-light text-white text-sm bg-blue-900 sm:flex gap-3 hidden  ">
...
<!-- floting and side sliding menu for small screans  -->
{#if show}
<div 
